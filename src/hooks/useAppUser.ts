  ...
  useEffect(() => {
    ...
    const syncFromProfile = async () => {
      ...
      setUser({
        ...
        phoneNumber: data?.phone ?? mockUser.phoneNumber,
        trustedContacts: persisted.trustedContacts ?? mockUser.trustedContacts,
        safePhrases: persisted.safePhrases ?? mockUser.safePhrases,
        escalationPlan: persisted.escalationPlan ?? mockUser.escalationPlan,
        sessions: persisted.sessions ?? mockUser.sessions,
